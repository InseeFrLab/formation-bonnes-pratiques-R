...
date: 14 Novembre 2022 et 29 Novembre 2022
slide-number: true
footer: |
...
- Grands principes :
  ...
  - Privilégier auto-documentation via des [**nommages pertinents**]{.orange}.
...
## :four: Pas d'ambiguité sur les _packages_ utilisés {.smaller}
...
- Des dizaines de `script.R` différents peuvent être considérés valides
à ce stade

. . .

- Si vous avez eu des difficultés avec une des questions, vous 
pouvez repartir de [cette version](https://raw.githubusercontent.com/InseeFrLab/formation-bonnes-pratiques-R/649b8955600c85cbd62c08c9697a264be5279be2/script.R)
...
- [`script.R`](https://github.com/InseeFrLab/formation-bonnes-pratiques-R/blob/8d42730279619fb85a818e5fbde7176096915c94/script.R)
- [`R/functions.R`](https://raw.githubusercontent.com/InseeFrLab/formation-bonnes-pratiques-R/8d42730279619fb85a818e5fbde7176096915c94/R/functions.R)
...
- Le fichier `_targets.R` doit satisfaire plusieurs conditions :
  1. Charger le_package_`targets` ;
  2. Charger dans l'environnement les fonctions nécessaires ;
  3. Déclarer les_packages_nécessaires aux différentes étapes ;
  4. Définir le *pipeline*.

![](img/targets.png){height="250" fig-align="center"}
...
## :three: Exécuter le *pipeline*

- La fonction `tar_make` exécute le *pipeline*
...
![](img/pipeline_run2.png){height="100" fig-align="center"}
...
{{< include applications/_application6a.qmd >}}

## Exercice 6B

{{< include applications/_application6b.qmd >}}
...
![](img/qmd.png){height="700" fig-align="center"}
