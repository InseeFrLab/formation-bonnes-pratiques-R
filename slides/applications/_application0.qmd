...
6. Créer un script `write_csv.R` en copiant le contenu de [cd fichier](https://raw.githubusercontent.com/InseeFrLab/formation-bonnes-pratiques-R/main/R/write_csv.R), puis l'exécuter
