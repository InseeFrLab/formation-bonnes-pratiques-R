...
3. Diagnostiquer le script `script.R` : `lintr::lint("R/script.R")`.
    + Regardez bien la liste des problèmes détectés par le _linter_.
    + Comprenez-vous la nature des problèmes?
4. Nettoyer le fichier `styler::style_file("R/script.R")`.
...
:::{.callout-tip collapse="true" icon=false}
## Partie 2 : premiers standards de qualité (suite)
