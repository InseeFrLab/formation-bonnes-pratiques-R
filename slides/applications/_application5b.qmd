...
8. Ouvrir un nouveau service `RStudio` sur le `SSPCloud` et cloner le projet dans les mêmes conditions que l'exercice 0. Regarder les messages dans la console. 
